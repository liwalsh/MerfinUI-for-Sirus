...
function MUI:Config()
    ...
    --MUI.Options.args.profiles.inline = true
    ...
    MUI.Options.args.profiles.args.media.args.resolution = ACH:Select(L["Preferable Resolution"], nil, 1, MUI.resolutions)
    ...
    --MUI.Options.args.layout.inline = true
    ...
    --MUI.Options.args.links.inline = true
