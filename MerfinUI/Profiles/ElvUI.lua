...
db.movers = function(layout)
	...
	if MUI:GetProfileResolution() == 'QUAD_HD' then
		...
		E.db.movers.BelowMinimapContainerMover = 'TOPRIGHT,ElvUIParent,TOPRIGHT,-238,-253'
		...
		E.db.movers.ElvUIBankMover = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,4,314'
		...
		E.db.movers.VehicleLeaveButton = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,490,137'
		E.db.movers.VehicleSeatMover = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,490,4'
		E.db.movers.VOICECHAT = 'TOPLEFT,UIParent,TOPLEFT,412,-81'
		E.db.movers.ElvAB_1 = 'BOTTOM,ElvUIParent,BOTTOM,-210,4'
		E.db.movers.ElvAB_2 = 'BOTTOM,ElvUIParent,BOTTOM,210,4'
		E.db.movers.ElvAB_3 = 'BOTTOM,ElvUIParent,BOTTOM,-210,39'
		E.db.movers.ElvAB_4 = 'BOTTOM,ElvUIParent,BOTTOM,210,39'
	...
	if layout == 'DPS/Tank' then
		...
		E.db.movers.ElvUF_Raid40Mover = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,4,314'
	...
	elseif MUI:GetProfileResolution() == 'FULL_HD' then
		...
		E.db.movers.ObjectiveFrameMover = 'TOPRIGHT,ElvUIParent,TOPRIGHT,-4,-306'
	...
	elseif layout == 'Healer-H' or layout == 'Healer-V' then
		...
		E.db.movers.ElvUF_PlayerMover = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,478,271'
		E.db.movers.ElvUF_PetMover = 'BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,478,180'
		E.db.movers.ElvUF_TargetMover = 'BOTTOMRIGHT,ElvUIParent,BOTTOMRIGHT,-478,271'
...
db.general = function()
	...
	elseif MUI:GetProfileResolution() == 'FULL_HD' then
		...
		E.db.general.minimap.timeFontSize = 13
...
db.chat = function()
	...
	if MUI:GetProfileResolution() == 'QUAD_HD' then
		E.db.chat.panelHeight = 282
		E.db.chat.panelWidth = 481
		E.db.chat.panelHeightRight = 395
		E.db.chat.panelWidthRight = 260
...
db.actionbars = function()
	...
	E.db.actionbar.barTotem.alpha = 0.85
	...
	if MUI:GetProfileResolution() == 'QUAD_HD' then
		...
		E.db.actionbar.barTotem.buttonsize = 36
...
db.unitframes = function(layout)
	...
	E.db.unitframe.units.player.customTexts.UnitHealthV2 = E.db.unitframe.units.player.customTexts.UnitHealthV2 or {}
	...
	E.db.unitframe.colors.health_backdrop.b = 0.98039221763611
	E.db.unitframe.colors.health_backdrop.g = 0.98039221763611
	E.db.unitframe.colors.health_backdrop.r = 0.98039221763611
	...
	E.db.unitframe.colors.transparentHealth = E.private.MUI.unitframes.transparentHealth
	...
	E.db.unitframe.units.player.customTexts.UnitHealthV2.attachTextTo = 'Health'
	E.db.unitframe.units.player.customTexts.UnitHealthV2.enable = false
	E.db.unitframe.units.player.customTexts.UnitHealthV2.font = MUI:GetProfileFont()
	E.db.unitframe.units.player.customTexts.UnitHealthV2.fontOutline = 'OUTLINE'
	E.db.unitframe.units.player.customTexts.UnitHealthV2.justifyH = 'RIGHT'
	E.db.unitframe.units.player.customTexts.UnitHealthV2.text_format = '[health:current] || [health:percent]'
	...
	E.db.unitframe.units.player.customTexts.UnitName.justifyH = 'RIGHT'
	...
	E.db.unitframe.units.target.buffs.priority = 'Blacklist,Personal,Friendly:nonPersonal'
	...
	E.db.unitframe.units.party.absorbPrediction.absorbTexture = MUI:GetProfileTexture()
	...
	E.db.unitframe.units.raid10.raidRoleIcons.enable = true
	E.db.unitframe.units.raid10.raidRoleIcons.position = 'TOPLEFT'
	E.db.unitframe.units.raid10.readycheckIcon.attachTo = 'Frame'
	E.db.unitframe.units.raid10.readycheckIcon.position = 'CENTER'
	E.db.unitframe.units.raid10.readycheckIcon.yOffset = 0
	...
	E.db.unitframe.units.raid25.raidRoleIcons.enable = true
	E.db.unitframe.units.raid25.raidRoleIcons.position = 'TOPLEFT'
	E.db.unitframe.units.raid25.readycheckIcon.attachTo = 'Frame'
	E.db.unitframe.units.raid25.readycheckIcon.position = 'CENTER'
	E.db.unitframe.units.raid25.readycheckIcon.yOffset = 0
	...
	E.db.unitframe.units.raid40.readycheckIcon.attachTo = 'Frame'
	...
	E.db.unitframe.units.raid40.buffs.countFont = MUI:GetProfileFont()
	E.db.unitframe.units.raid40.buffs.anchorPoint = 'BOTTOMLEFT'
	E.db.unitframe.units.raid40.debuffs.countFont = MUI:GetProfileFont()
	...
	if MUI:GetProfileResolution() == 'QUAD_HD' then
		...
		E.db.unitframe.units.player.customTexts.UnitHealthV2.size = 14
		E.db.unitframe.units.player.customTexts.UnitHealthV2.xOffset = -3
		E.db.unitframe.units.player.customTexts.UnitHealthV2.yOffset = 10
		E.db.unitframe.units.player.customTexts.UnitName.size = 14
		E.db.unitframe.units.player.customTexts.UnitName.xOffset = -3
		E.db.unitframe.units.player.customTexts.UnitName.yOffset = 10
		...
		E.db.unitframe.units.pet.customTexts.UnitPower.size = 14
		...
		E.db.unitframe.units.targettarget.customTexts.UnitName.size = 14
		...
		E.db.unitframe.units.boss.customTexts.UnitHealth.size = 14
	...
	if layout == 'DPS/Tank' then
		...
		E.db.unitframe.units.raid10.buffs.countFontSize = 13
		...
		E.db.unitframe.units.raid10.debuffs.countFontSize = 13
		...
		E.db.unitframe.units.raid25.buffs.countFontSize = 13
		...
		E.db.unitframe.units.raid25.debuffs.countFontSize = 13
		...
		E.db.unitframe.units.raid40.buffs.countFontSize = 13
	...
	elseif MUI:GetProfileResolution() == 'FULL_HD' then
		...
		E.db.unitframe.units.player.customTexts.UnitHealth.yOffset = 0
		E.db.unitframe.units.player.customTexts.UnitHealthV2.size = 13
		E.db.unitframe.units.player.customTexts.UnitHealthV2.xOffset = -2
		E.db.unitframe.units.player.customTexts.UnitHealthV2.yOffset = -8
		E.db.unitframe.units.player.customTexts.UnitName.size = 13
		E.db.unitframe.units.player.customTexts.UnitName.xOffset = -2
		E.db.unitframe.units.player.customTexts.UnitName.yOffset = 8
...
db.nameplates = function()
	...
	for _, nameplateType in ipairs(plates) do
		...
		E.db.nameplates.units[nameplateType].debuffs.anchorPoint = 'TOPLEFT'
...
function MUI:LoadPlugins()
	...
	if plugins['DataText Bar 2'] then
		...
		if MUI:GetProfileResolution() == 'QUAD_HD' then
			...
			E.db.dtbars.DTB2_DBT2_LeftBottomBar.width = 481
