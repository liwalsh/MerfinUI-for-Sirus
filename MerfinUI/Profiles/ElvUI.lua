...
db.unitframes = function(layout)
	...
	E.db.unitframe.units.player.customTexts.UnitPower.yOffset = -8
	...
	E.db.unitframe.units.player.customTexts.UnitHealth.text_format = "[health:current] || [health:percent]"
	E.db.unitframe.units.player.customTexts.UnitHealth.xOffset = -2
	E.db.unitframe.units.player.customTexts.UnitHealth.yOffset = -8
	E.db.unitframe.units.player.customTexts.UnitName.attachTextTo = "Health"
	E.db.unitframe.units.player.customTexts.UnitName.enable = true
	...
	E.db.unitframe.units.player.portrait.enable = E.private.MUI.unitframes.unitportrait
	...
	E.db.unitframe.units.target.customTexts.UnitPower.yOffset = -8
	...
	E.db.unitframe.units.target.portrait.enable = E.private.MUI.unitframes.unitportrait
	...
	E.db.unitframe.units.targettarget.portrait.enable = E.private.MUI.unitframes.unitportrait
	E.db.unitframe.units.targettarget.portrait.overlay = true
	E.db.unitframe.units.targettarget.portrait.fullOverlay = false
	...
	E.db.unitframe.units.pet.portrait.enable = E.private.MUI.unitframes.unitportrait
	E.db.unitframe.units.pet.portrait.overlay = true
	E.db.unitframe.units.pet.portrait.fullOverlay = false
	...
	E.db.unitframe.units.focus.customTexts.UnitPower.yOffset = -8
	...
	E.db.unitframe.units.focus.portrait.enable = E.private.MUI.unitframes.unitportrait
